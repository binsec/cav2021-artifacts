...
module type Context = sig type t end
...
(* Empty denotes that the concretization has no value. Note that this
...
module type Base = sig
  ...
  (* MAYBE: Renommer Empty en Void? ou en None? ou en Nothing? ou en NoValue?*)
