...
$(eval $(call defcunit,sse,\
	sse_options \
	sse_symbolic sse_graph sse_dom \
	sse_types sse_utils \
	sse_smt \
	sse,,CEA))
...
DIRS+=unittests
TESTS_FILES=$(addprefix unittests/, t_main t_formula t_string_utils t_sequence)
TESTS_ML_FILES=$(addsuffix .ml, $(TESTS_FILES))
TESTS_MLI_FILES=$(addsuffix .mli, $(TESTS_FILES))
...
TESTS_CMO_FILES = $(TESTS_ML_FILES:%.ml=%.cmo)
TESTS_CMX_FILES = $(TESTS_ML_FILES:%.ml=%.cmx)
TESTS_CMI_FILES = $(TESTS_MLI_FILES:%.ml=%.cmi)

CAMLINCLUDES = $(DIRS:%=-I %)
CAMLFILES = $(MLI_FILES) $(ML_FILES) $(TESTS_ML_FILES) $(TESTS_MLI_FILES)
