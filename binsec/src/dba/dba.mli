...
module Non_deterministic_tag : sig
  type t
  type control = Uncontrolled | Controlled | Parameter
  val create : ?name:string -> ?region:region -> ?controlled:control -> unit -> t
  val region : t -> region
  val name : t -> string option
  val controlled :  t -> control
...
module Instr : sig
  ...
  val non_deterministic : ?tag:Non_deterministic_tag.t -> LValue.t -> int -> t
