...
type d = private
  | Reach of Count.t * Dba.Expr.t option (** number of times to reach an address with
                                      a specified condition *)
  | Enumerate of Count.t * Dba.Expr.t (** number of times to reach an address,
                                          and expression to evaluate *)
  | Cut
...
val reach : ?n:int -> ?cond:Dba.Expr.t -> Loader_utils.Binary_loc.t -> t
val reach_all : ?cond:Dba.Expr.t -> Loader_utils.Binary_loc.t -> t
