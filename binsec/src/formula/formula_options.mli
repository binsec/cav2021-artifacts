...
module OptimRowUnfold : Cli.BOOLEAN

module OptimSsa : Cli.BOOLEAN

module OptimLst : Cli.INTEGER

module TaintRow : Cli.BOOLEAN

type universal_mode = Quantifier | Taint

module UniversalMode : Cli.GENERIC with type t = universal_mode

module UnquantifyMemory : Cli.BOOLEAN

module UnquantifyMemoryApprox : Cli.BOOLEAN

module InvertExistentials : Cli.BOOLEAN

module InvertExistentialsIncomplete : Cli.BOOLEAN
