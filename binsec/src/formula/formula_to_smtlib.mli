...
(** converts a list of entries to a list of commangs. If logic is not None
 * (default, Some(QF_ABV)) then prepend the corresponding set-logic command *)
val formula : ?logic:(string option) -> Formula.formula -> Smtlib.script
