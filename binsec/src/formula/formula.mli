...
val not_bv_comp : bv_comp -> bv_comp

(* Non smart constructor *)

val bv_term_raw : bv_term_desc -> bv_term
...
(** builds an all-zero bitvector term of the specifed size *)
val mk_bv_zeros : int -> bv_term

(** builds the bitvector term representing 1 of the specifed size *)
val mk_bv_ones  : int -> bv_term

(** builds an all-one bitvector term of the specifed size *)
...
module BlVarMap : Map.S with type key = bl_var
module BvVarMap : Map.S with type key = bv_var
module AxVarMap : Map.S with type key = ax_var
...
module BlTermHashamt : Hashamt.S with type key = bl_term
module BvTermHashamt : Hashamt.S with type key = bv_term
module AxTermHashamt : Hashamt.S with type key = ax_term
